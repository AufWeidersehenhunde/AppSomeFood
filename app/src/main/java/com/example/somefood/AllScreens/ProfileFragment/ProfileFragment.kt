...
import com.example.somefood.AllScreens.ProfileFragment.DataProfile.LastFeedback
import com.example.somefood.AllScreens.ProfileFragment.DataProfile.MostOrdered
import com.example.somefood.AllScreens.ProfileFragment.DataProfile.OrdersStats
import com.example.somefood.Utils.PhotoProfile
...
class ProfileFragment : Fragment(R.layout.fragment_profile) {
    ...
    private fun initViewOrderData(order: OrdersStats) {
        with(viewBinding) {
    ...
    private fun initViewMostOrdered(counter: MostOrdered) {
        with(viewBinding) {
    ...
    private fun initViewLastFeedback(feedback: LastFeedback) {
        with(viewBinding) {
