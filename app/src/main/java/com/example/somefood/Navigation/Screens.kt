package com.example.somefood.Navigation
...
import com.example.appsomefood.Orders.OrdersClientFragment
import com.example.appsomefood.OrdersInWork.OrdersCreatorFragment
...
object Screens {
    ...
    fun routeToOrdersFragment() = FragmentScreen { OrdersClientFragment() }
    fun routeToCreatorList() = FragmentScreen { CreatorListFragment() }
    fun routeToOrdersWork() = FragmentScreen { OrdersCreatorFragment() }
}
