...
fun getFoods(): List<FoodDb> {
    return listOf(
        FoodDb(
            ...
            "Potatoes,salted butter,mushroom,brown lentils,gloves Garlics,salt, onion, olive oil, white wine, vegetable stock, soy sauce,tomato  "
        ),
        FoodDb(
            "2",
            ...
            "Butter, peanut cookies, gelatine leafs, riccota, peanut butter, milk, double cream, peanut brittle"
        ),
        FoodDb(
            "3",
            "Christmas cake",
            ...
            "Butter, muscovado sugar, plain flour, eggs, ground almonds, sherry, cherry, raisins, lemon, spice rose water"
        ),
        FoodDb(
            "4",
            ...
            "Chicken, onion, carrots, leek,  celery, cabbage, allspice, pepper, salt"
        ),
        FoodDb(
            "5",
            "Eton Mess",
            ...
            "Strawberries, double cream, meringue nests, ginger cordial, mint"
        ),
        FoodDb(
            "6",
            "Japanese Katsudon",
            ...
            "Eggs, soy sauce, vegetable oil, onion, pork, sushi rice, sugar, mirin"
        ),
        FoodDb(
            "7",
            "Chicken Karaage",
            ...
            "Chicken, garlic, soy sauce, sake, sugar, limon, vegetable oil, starch"
        ),
        FoodDb(
            "8",
            "Beef Bourguignon",
            ...
            "Goose fat, beef, bacon, mushroom,  garlic, tomato, red wine, olive oil, cardamom, celeriac"
        ),
        FoodDb(
            "9",
            ...
            "Olive oil, red chili, vegetable cube, coconut milk, fish sauce, lime, rice noodles, paste"
        ),
        FoodDb(
            "10",
            "Chicken Parmentier",
            ...
            "Potatoes, butter, double cream,egg yolks, shallots, carrots, garlic, celery, white wine, tomato, black olives, chicken "
        ),
        FoodDb(
            "11",
            ...
            "Beef, oil, red wine, carrots, onion, beef stock, egg yolks, butter, salt, pepper"
        ),
        FoodDb(
            "12",
